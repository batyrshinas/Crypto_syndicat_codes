...
sudo wget 'https://github.com/subspace/subspace-cli/releases/download/v0.1.11-alpha/subspace-cli-ubuntu-x86_64-v3-v0.1.11-alpha'
speep 15
sudo chmod +x subspace-cli-ubuntu-x86_64-v3-v0.1.11-alpha

sudo mv subspace-cli-ubuntu-x86_64-v3-v0.1.11-alpha /usr/local/bin/
sudo rm -rf $HOME/.config/subspace-cli-ubuntu-x86_64-v3-v0.1.11-alpha
...
/usr/local/bin/subspace-cli-ubuntu-x86_64-v3-v0.1.11-alpha init
...
User=$USER
Type=simple
ExecStart=/usr/local/bin/subspace-cli-ubuntu-x86_64-v3-v0.1.11-alpha farm --verbose
Restart=on-failure
LimitNOFILE=1024000
